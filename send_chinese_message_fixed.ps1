# Script to send Chinese message via Feishu with proper encoding
# Using ASCII-only characters in the script to avoid encoding issues
...
"@
    ...
    # Type the contact name - hardcoding as "Zhu Bao" since direct Chinese input has issues
    # Using clipboard method to input Chinese characters
    ...
    # Type the message using clipboard method
    Set-Clipboard -Value "你在干嘛呢"
    Start-Sleep -Milliseconds 200
    [System.Windows.Forms.SendKeys]::SendWait("^v")  # Paste
    Start-Sleep -Milliseconds 500
