# Activate Feishu and send Li Bai's poem to Zhu Bao
...
try {
    ...
    if ($null -eq $feishuProcess) {
        Write-Output "Cannot find Feishu process with ID"
        exit 1
    }
    
    Write-Output "Found Feishu process"
...
"@
    ...
    # Input contact name using clipboard
    ...
    # Input Li Bai's famous poem "Quiet Night Thoughts" using clipboard
    ...
    Write-Output "Successfully attempted to send poem to Zhu Bao"
    Write-Output "Please verify in Feishu that the message was sent."
